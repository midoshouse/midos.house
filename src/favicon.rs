...
impl ChestAppearances {
    ...
    pub(crate) fn random() -> Self {
        ...
        static WEIGHTS: Lazy<Vec<(ChestAppearances, usize)>> = Lazy::new(|| serde_json::from_str(include_str!("../assets/chests-rsl-cf48406.json")).expect("failed to parse chest weights"));
