...
pub(crate) fn favicon(url: &Url) -> RawHtml<String> {
    match url.host_str() {
        ...
        Some("bingosync.com" | "www.bingosync.com") => html! {
            img(class = "favicon", alt = "external link (bingosync.com)", src = "https://bingosync.com/static/bingosync/favicon-32x32.png");
        },
        ...
        Some("triforceblitz.com" | "www.triforceblitz.com" | "dev.triforceblitz.com") => html! {
            img(class = "favicon", alt = "external link (triforceblitz.com)", src = "https://triforceblitz.com/static/images/logo.svg");
        },
            ...
            body(class = matches!(style.kind, PageKind::Banner).then(|| "fullscreen")) {
                ...
                footer {
                    ...
                    p {
                        : "Special thanks to ";
                        : maplestar;
                        : " for some of the chest icons used in the logo, and to ";
                        : xopar;
                        : " and ";
                        : shirosoluna;
                        : " for some of the seed hash icons!";
                    }
                }
            }
        }
...
pub(crate) async fn rocket(global: Arc<GlobalState>, port: u16) -> Result<Rocket<rocket::Ignite>, crate::Error> {
    ...
    .mount("/", rocket::routes![
        ...
        event::volunteer,
        event::add_volunteer,
        event::remove_volunteer,
        event::enter::get,
        event::enter::post,
        event::teams::get,
        event::configure::get,
        event::configure::post,
        event::configure::restream_coordinators_get,
        event::configure::add_restream_coordinator,
        event::configure::remove_restream_coordinator,
        favicon::favicon_ico,
        favicon::favicon_png,
        crate::mw::index,
        crate::mw::platforms,
