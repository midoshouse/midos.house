...
pub(super) async fn info(transaction: &mut Transaction<'_, Postgres>, data: &Data<'_>) -> Result<RawHtml<String>, InfoError> {
    ...
    let sample_seeds = match &*data.event {
        "5" => Some(seed::table(stream::iter(vec![
            seed::Data { file_hash: None, files: seed::Files::MidosHouse { file_stem: Cow::Borrowed("OoT_F35CF_7F1NK3FEGY") } },
            seed::Data { file_hash: None, files: seed::Files::MidosHouse { file_stem: Cow::Borrowed("OoT_F35CF_XULLQE310I") } },
