...
pub(crate) fn settings_2026(alr: bool) -> seed::Settings {
    collect![
        format!("user_message") => json!("SGL 2026 Tournament"),
        format!("password_lock") => json!(true),
        format!("reachable_locations") => json!(if alr { "all" } else { "beatable" }),
        format!("triforce_count_per_world") => json!(28),
        format!("triforce_goal_per_world") => json!(24),
        format!("bridge") => json!("stones"),
        format!("bridge_rewards") => json!(7),
        ...
        format!("hint_dist_user") => json!({
            "name":                  "sgl",
            "gui_name":              "SGL 2026",
            "description":           "Hint distribution used for SGL 2026.",
            "add_locations":         [
                { "location": "Deku Theater Skull Mask", "types": ["always"] },
            ],
            "remove_locations":      [
