...
pub(crate) async fn info(global: &GlobalState, transaction: &mut Transaction<'_, Postgres>, data: &Data<'_>) -> Result<Option<RawHtml<String>>, InfoError> {
    ...
    let sample_seeds = match &*data.event {
        ...
        "rs2" => Some(seed::table(global, stream::iter(vec![
            ...
            seed::Data { file_hash: None, password: None, bingo: None, files: Some(seed::Files::MidosHouse { file_stem: Cow::Borrowed("OoT_5ADE7_3OBW74243M"), locked_spoiler_log_path: None }), progression_spoiler: false },
            seed::Data { file_hash: None, password: None, bingo: None, files: Some(seed::Files::MidosHouse { file_stem: Cow::Borrowed("OoT_5ADE7_E18HE17UKF"), locked_spoiler_log_path: None }), progression_spoiler: false },
        ]), true, true).await?),
        _ => None,
    };
...
pub(crate) fn race5_settings() -> seed::Settings {
    collect![
