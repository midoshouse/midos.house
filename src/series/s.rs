...
pub(crate) const SHORT_WEEKLY_SETTINGS: &str = "SAWS";
fn long_weekly_settings() -> RawHtml<String> {
    html! {
        p {
            ...
            : format_datetime(Utc.with_ymd_and_hms(2025, 2, 1, 23, 00, 00).single().expect("wrong hardcoded datetime"), DateTimeFormat { long: false, running_text: true });
            : " are the ";
            a(href = "https://docs.google.com/document/d/1vS7JrYjlWFkXfUnT5BJSQ19ywJa-TiB7RPK7Uz0JLsU/edit") : "Standard Anti-Weekly Settings (SAWS)";
            : ".";
        }
    }
}
...
pub(crate) fn weekly_settings_2025w06() -> serde_json::Map<String, Json> {
    collect![
        format!("password_lock") => json!(true),
        ...
        format!("adult_trade_shuffle") => json!(true),
