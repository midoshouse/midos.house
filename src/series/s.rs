...
pub(crate) fn s10_test_settings_week1() -> seed::Settings {
    collect![
        format!("user_message") => json!("S10 Testing Week 1"),
        format!("password_lock") => json!(true),
        ...
        format!("hint_dist_user") => json!({
            "name":                  "s10test_week1",
            "gui_name":              "S10 Testing Week 1",
            "description":           "Hint Distribution for S10 testing week 1",
            "add_locations":         [
            ...
            "distribution":          {
                ...
                "song":            {"order": 6, "weight": 0.0, "fixed": 0, "copies": 2},
                "dual":            {"order": 7, "weight": 0.0, "fixed": 2, "copies": 2},
                "sometimes":       {"order": 8, "weight": 0.0, "fixed": 4, "copies": 2},
