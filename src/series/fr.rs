...
pub(crate) const S3_SETTINGS: [S3Setting; 28] = [
    ...
    S3Setting { name: "merchants", display: "merchants", default: "off", default_display: "vanilla merchants", other: &[("shuffle", false, "shuffled merchants")], description: "merchants: off (défaut) ou shuffle" },
    ...
    S3Setting { name: "dungeon-er", display: "dungeon ER", default: "off", default_display: "no dungeon ER", other: &[("on", false, "dungeon ER")], description: "dungeon-er: off (défaut), on ou mixed" },
