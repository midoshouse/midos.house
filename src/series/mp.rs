...
pub(crate) async fn info(transaction: &mut Transaction<'_, Postgres>, data: &Data<'_>) -> Result<Option<RawHtml<String>>, InfoError> {
    Ok(match &*data.event {
        ...
        "5" => Some(html! {
            div(class = "toc") {
                article {
                    h2 : "Welcome to the 5th Season of the Mixed Pools Tournament";
                    p {
                        : "Organized by ";
                        : English.join_html_opt(data.organizers(transaction).await?);
                        : ". Thank you also to ";
                        : User::from_id(&mut **transaction, Id::from(5246396495391975113_u64)).await?.unwrap(); // BearKofca
                        : ", ";
                        : User::from_id(&mut **transaction, Id::from(14099802746436324950_u64)).await?.unwrap(); // TeaGrenadier
                        : " and ";
                        : User::from_id(&mut **transaction, Id::from(5961856224563339148_u64)).await?.unwrap(); // WTHH
                        : " for their continuing support within the team!";
                    }
                    p {
                        a(href = "https://docs.google.com/spreadsheets/d/1Czm7o5vI3uafdjAsEuHa8VyX2ts52oFf1L4LFJqbNmc/edit?gid=1885752948#gid=1885752948") : "Swiss and tiebreaker matchups and results";
                    }
                    h2(id = "signing-up") : "Signing Up";
                    p {
                        strong {
                            : "Deadline is ";
                            : format_datetime(Utc.with_ymd_and_hms(2026, 6, 2, 0, 0, 0).single().expect("wrong hardcoded datetime"), DateTimeFormat { long: true, running_text: true });
                            : ".";
                            br;
                            : "Start of the first round is June 3rd after the wheel spin.";
                        }
                    }
                    h2(id = "settings") : "Settings";
                    ul {
                        ...
                        li : "Cheap scrubs, shopsanity 4";
                        li : "Cowsanity";
                        li : "Ganon's boss key on 9 dungeon rewards; reward locations (bosses) can be found in the pause menu";
                        li : "Open bridge, open Zora's fountain, open Deku Tree, open Gerudo's Fortress";
                        li : "CAMC (size and texture)";
                        li : "30 / 40 / 50 skulls are off; 20 skulls hinted in the House of Skulltula";
                        li : "3 cuccos";
                        li : "Ruto at F1";
                        li : "Fast Shadow Boat";
                        li : "Mask of Truth is enabled";
                    ...
                    ul {
                        li : "5x Way of the hero hints";
                        li : "3x foolish hints: 2 dungeons and 1 overworld area";
                        li : "3x Always hints: Biggoron, Frogs 2 and Link's House Cow";
                        li : "1x Always dual hint: Skull Mask & Mask of Truth";
                        li : "2x Always entrance hints: Forest and Shadow boss door entrances";
                        li : "2x Dual sometimes hints";
                        li : "2x Entrance sometimes hints";
                        li : "2x Sometimes hints";
                    }
                    h2(id = "good-to-know") : "Good to Know";
                    ul {
                        li {
                        ...
                        li : "Ganon's Tower is considered part of the hint area it's connected to, like interiors, other boss rooms, etc";
                        li : "Warp songs: there will not be multiple warp songs that lead to the same region.";
                        li : "FW logic: You might be logically required to set FW in a dungeon to change time of day to gain access to nearby entrances.";
                        li : "Blue warp logic: Every time you enter a blue warp in a boss room, the time of day will be set to its vanilla behaviour. This is now repeatable and therefore in logic to change time of day to access certain areas. All warps set it to noon EXCEPT Morpha which sets it to morning.";
                    }
                    h2(id = "entrances-information") : "Entrances Information";
                    p {
                        : "Here is a list of entrances that ";
                    ...
                    h2(id = "gameplay-rules") : "Gameplay Rules";
                    p {
                        : "All races will be completed abiding by the Standard ruleset. You can find the Universal Racing rules, Standard rules and Emulator rules on the ";
                        a(href = "https://wiki.ootrandomizer.com/index.php?title=Main_Page") : "OoT Randomizer Wiki";
                        : "). The ";
                        a(href = "https://wiki.ootrandomizer.com/index.php?title=Racing_Infractions") : "Infraction System";
                        : " will be used within this tournament.";
                    }
                    p : "Note: Crossing the Gerudo Valley bridge as a child shall be banned unless it is from back to front.";
                    p : "Standard timing rules apply: .done is on the first frame of the cutscene that plays after beating Ganon.";
                    p {
                    ...
                    h2(id = "tournament-structure") : "Tournament Structure";
                    p : "The tournament structure will begin with Swiss rounds followed by a Single Elimination Top 16 Bracket. All matches will be Bo1 except for the Grand Finals, which will be Bo3.";
                    p {
                        : "The number of Swiss rounds is to be determined and will depend on the number of entrants for the tournament. It will be announced shortly after opt-ins close on June 1st. It will be between 4 to 6 rounds, with the first round being paired randomly (";
                        strong : "no seeding async";
                        : "). For Rounds 2 and after, players will race others with the same number of Swiss phase wins. In those individual brackets, we will continue to draw randomly (0-1 faces 0-1, 2-1 faces 2-1, etc.). ";
                        em : "In the event of an odd number of players, a random player in the lowest score group who has not yet received a bye will receive a bye.";
                    }
                    h2(id = "scheduling-and-racing") : "Scheduling and Racing";
                    p : "Scheduling and seed rolling will be handled through Mido's House and will be password protected.";
                    p : "Prerolling a seed by Mido is set up to reduce waiting time on generating a seed. Matches that are scheduled on short notice might have to wait a bit, please be patient.";
                    p {
                        : "Seeds can also be generated on Fenhl's branch v9.0.42-2 with the ";
                        a(href = "https://ootrandomizer.com/generatorDev?version=devFenhl_9.0.42-2") : "5th Mixed Pools Tournament preset";
                    }
                    p : "We are looking to get through this tournament quickly and efficiently. Thus, all matchmaking should honor the following time constraints:";
                    ul {
                        li : "Matches should be scheduled within 48 hours of the matchup being known.";
...
pub(crate) fn s1_settings() -> seed::Settings {
    collect![
        format!("user_message") => json!("Mixed Pools Tournament"),
        ...
        format!("logic_earliest_adult_trade") => json!("prescription"),
...
pub(crate) fn s5_settings() -> seed::Settings {
    collect![
        format!("user_message") => json!("5th Mixed Pools Tournament"),
        format!("password_lock") => json!(true),
