    ...
    fn to_html(&self) -> RawHtml<String> {
        html! {
            @match self {
                ...
                Self::MasterSword => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/master-sword.png"), srcset = format!("{} 10x", static_url!("hash-icon-500/master-sword.png")));
