...
if subprocess.run(['wsl', '-d', 'ubuntu-m2', 'env', '-C', '/home/fenhl/wslgit/github.com/midoshouse/midos.house', '/home/fenhl/.cargo/bin/cargo', 'sqlx', 'prepare', '--check']).returncode != 0:
    sys.exit("update .sqlx (wsl -d ubuntu-m2 sh -c 'rsync --delete -av /mnt/c/Users/fenhl/git/github.com/midoshouse/midos.house/stage/ /home/fenhl/wslgit/github.com/midoshouse/midos.house/ --exclude target && env -C /home/fenhl/wslgit/github.com/midoshouse/midos.house /home/fenhl/.cargo/bin/cargo sqlx prepare && rsync --delete -av /home/fenhl/wslgit/github.com/midoshouse/midos.house/.sqlx/ /mnt/c/Users/fenhl/git/github.com/midoshouse/midos.house/stage/.sqlx/')")
